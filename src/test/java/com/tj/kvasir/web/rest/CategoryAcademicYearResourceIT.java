...
public class CategoryAcademicYearResourceIT {
    ...
    public void setup() {
        ...
        final CategoryAcademicYearResource categoryAcademicYearResource = new CategoryAcademicYearResource(categoryAcademicYearRepository, mockCategoryAcademicYearSearchRepository);
