...
public class CategoryPublisherResourceIntTest {
    ...
    public void createCategoryPublisher() throws Exception {
        ...
        assertThat(categoryPublisherEs).isEqualToIgnoringGivenFields(testCategoryPublisher);
    }
    ...
    public void updateCategoryPublisher() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedCategoryPublisher are not directly saved in db
        em.detach(updatedCategoryPublisher);
