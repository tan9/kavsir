...
public interface QuestionChoiceRepository extends JpaRepository<QuestionChoice,Long> {
    ...
    Page<QuestionChoice> findByMultipleResponse(boolean multipleResponse, Pageable pageable);
    ...
    Page<QuestionChoice> findByCategories(@Param("categoryIds") Set<Long> categoryIds, Pageable pageable);
    ...
    Page<QuestionChoice> findByCategoriesAndMultipleResponse(@Param("categoryIds") Set<Long> categoryIds,
