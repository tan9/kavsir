...
public class CategorySourceResourceIntTest {
    ...
    public void setup() {
        ...
        final CategorySourceResource categorySourceResource = new CategorySourceResource(categorySourceRepository, categorySourceSearchRepository);
    ...
    public void createCategorySource() throws Exception {
        ...
        assertThat(categorySourceEs).isEqualToIgnoringGivenFields(testCategorySource);
    }
    ...
    public void updateCategorySource() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedCategorySource are not directly saved in db
        em.detach(updatedCategorySource);
