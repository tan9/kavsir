...
public class CategorySubjectResourceIT {
    ...
    public void setup() {
        ...
        final CategorySubjectResource categorySubjectResource = new CategorySubjectResource(categorySubjectRepository, mockCategorySubjectSearchRepository);
     ...
     * if they test an entity which requires the current entity.
     */
    public static CategorySubject createUpdatedEntity(EntityManager em) {
        CategorySubject categorySubject = new CategorySubject()
