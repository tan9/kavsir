...
public class CategoryGradeResourceIntTest {
    ...
    public void setup() {
        ...
        final CategoryGradeResource categoryGradeResource = new CategoryGradeResource(categoryGradeRepository, categoryGradeSearchRepository, categoryNodeRepository);
