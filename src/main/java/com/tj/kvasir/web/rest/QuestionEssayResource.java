...
public class QuestionEssayResource {
    ...
    public ResponseEntity<List<QuestionEssayDTO>> getAllQuestionEssays(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        if (eagerload) {
            ...
            page = questionEssayService.findAll(pageable);
        }
    ...
    public ResponseEntity<List<QuestionEssayDTO>> searchQuestionEssays(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
