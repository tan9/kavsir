...
public class CategorySourceResourceIT {
    ...
    public void setup() {
        ...
        final CategorySourceResource categorySourceResource = new CategorySourceResource(categorySourceRepository, mockCategorySourceSearchRepository);
     ...
     * if they test an entity which requires the current entity.
     */
    public static CategorySource createUpdatedEntity(EntityManager em) {
        CategorySource categorySource = new CategorySource()
