...
describe('Service Tests', () => {
    ...
    describe('CategoryAcademicYear Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CategoryAcademicYearService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/category-academic-years';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CategoryAcademicYear', () => {
