...
public class QuestionChoiceResource {
    ...
    public ResponseEntity<List<QuestionChoiceDTO>> getAllQuestionChoices(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        if (eagerload) {
            ...
            page = questionChoiceService.findAll(pageable);
        }
    ...
    public ResponseEntity<List<QuestionChoiceDTO>> searchQuestionChoices(@RequestParam String query, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
