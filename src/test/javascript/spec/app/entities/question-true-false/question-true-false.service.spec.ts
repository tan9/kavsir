...
describe('Service Tests', () => {
  describe('QuestionTrueFalse Service', () => {
    ...
    let elemDefault: IQuestionTrueFalse;
    let expectedResult;
    beforeEach(() => {
      ...
      elemDefault = new QuestionTrueFalse(0, false, 'AAAAAAA', 'AAAAAAA', 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a QuestionTrueFalse', async () => {
        ...
        service
          .create(new QuestionTrueFalse(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a QuestionTrueFalse', async () => {
        const returnedFromService = Object.assign(
          {
            correct: true,
            text: 'BBBBBB',
      ...
      it('should return a list of QuestionTrueFalse', async () => {
        const returnedFromService = Object.assign(
          {
            correct: true,
            text: 'BBBBBB',
      ...
      it('should delete a QuestionTrueFalse', async () => {
