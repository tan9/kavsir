...
public class CategoryAcademicYearResourceIntTest {
    ...
    public void setup() {
        ...
        final CategoryAcademicYearResource categoryAcademicYearResource = new CategoryAcademicYearResource(categoryAcademicYearRepository, categoryAcademicYearSearchRepository, categoryNodeRepository);
    ...
    public void createCategoryAcademicYear() throws Exception {
        ...
        assertThat(categoryAcademicYearEs).isEqualToIgnoringGivenFields(testCategoryAcademicYear);
    }
